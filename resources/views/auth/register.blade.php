    ...
    <div class="container">
        ...
        <div class="col-md-12 d-flex align-items-center justify-content-between my-4">
            <section class="col-md-6">
                <img src="{{ asset('images/register.png') }}" alt="image-register" style="width: 450px; height: 350px;">
            </section>
            <section class="col-md-6 card p-4 border-0 shadow bg-body" style="border-radius: 10px;">
                ...
                <form action="{{ route('register_user') }}" method="POST">
                    <h3 class="fw-bold mb-2">Register</h3>
                    <p class="mb-4">Tolong lakukan registrasi jika belum punya akun</p>
                    @csrf
