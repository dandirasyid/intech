    ...
    <div class="container">
        <div class="bg-body my-4 p-3 border-0 rounded shadow">
            <div class="d-flex justify-content-center align-items-center mb-1 col-md-12">
                <form action="{{ route('admin_dosen.store') }}" method="POST" enctype="multipart/form-data" class="col-md-8">
                    @csrf
                    ...
                    <div class="form-group d-flex mb-3 justify-content-between">
                        ...
                        <div style="width: 70%;">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="kelas_id[]" value="{{ $kelasItem->id }}" id="kelas{{ $kelasItem->id }}">
