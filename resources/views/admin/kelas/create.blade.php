    ...
    <div class="container">
        <div class="bg-body my-4 p-3 border-0 rounded shadow">
            <div class="d-flex justify-content-center align-items-center mb-1 col-md-12">
                ...
                @endif
                <form action="{{ route('admin_kelas.store') }}" method="POST" enctype="multipart/form-data" class="col-md-8 my-5">
                    @csrf
                    <div class="form-group mb-5">
                        <h5 class="text-center fw-bold ">Tambah Kelas</h5>
                    </div>

                    <div class="form-group mb-3 d-flex justify-content-between">
                        <label for="name" class="fw-bold mb-1">Name</label>
                        <div style="width: 70%;">
                            <input type="text" name="name" id="name" class="form-control rounded-3 @error('name') is-invalid @enderror" placeholder="Contoh: A" required>
                        </div>
                    </div>
                    @error('name')
