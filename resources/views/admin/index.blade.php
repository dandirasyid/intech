        ...
        <div class="bg-body my-4 p-3 border-0 rounded shadow">
            <div class="d-flex align-items-center justify-content-between" style="margin: 0 100px;">
                <div>
                    ...
                    <p>Dashboard admin untuk pemantauan data</p>
                </div>
                <div>
                    <img src="{{ asset('images/admin-hero.png') }}" alt="image-admin" width="400px">
                </div>
            </div>

            <div class="col-md-12 d-flex justify-content-center gap-3 my-3">
                ...
                <div class="card col-md-2 rounded" style="border-color: #10439F;">
                    <img src="{{ asset('images/lecturer.png') }}" class="card-img-top" alt="card" height="150px">
                    <div class="card-body">
                        <h5 class="card-title text-center">Total Dosen</h5>
                        <h2 class="card-title text-center" style="color:  #10439F;">{{ $dosenCount }}</h2>
                    </div>
                </div>
                <div class="card col-md-2 rounded" style="border-color: #10439F;">
