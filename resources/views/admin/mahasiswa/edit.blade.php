    ...
    <div class="container">
        <div class="bg-body my-4 p-3 border-0 rounded shadow">
            <div class="d-flex justify-content-center align-items-center mb-1 col-md-12">
                <form action="{{ route('admin_mahasiswa.update', $mahasiswa->id) }}" method="POST" enctype="multipart/form-data" class="col-md-8">
                    @csrf
                    @method('PUT')
                    <div class="form-group upload">
                        <img src="{{ $mahasiswa->image ? Storage::url($mahasiswa->image) : asset('images/default_profile.png') }}" id="profileImage" class="rounded-circle mb-2" alt="logo-medsos" width="100px" height="85px">
                    ...
                    <div class="form-group mb-3 d-flex justify-content-between">
                        ...
                        <div style="width: 70%;">
                            <input type="text" name="name" id="name" class="form-control rounded-3 @error('name') is-invalid @enderror" placeholder="Masukan nama lengkap" value="{{ $mahasiswa->name }}" required>
                        </div>
                    </div>
                    @error('name')
                    ...
                    <div class="form-group d-flex mb-3 justify-content-between">
                        ...
                        <div style="width: 70%;">
                            <input type="email" name="email" id="email" class="form-control rounded-3 @error('email') is-invalid @enderror" placeholder="Masukan email" value="{{ $mahasiswa->email }}" required>
                        </div>
                    </div>
                    @error('email')
                    <div class="text-danger mt-2">{{ $message }}</div>
                    ...
                    <div class="form-group d-flex mb-3 justify-content-between">
                        ...
                        <div style="width: 70%;">
                            <input type="password" name="password_confirmation" id="password_confirmation" class="form-control rounded-3 @error('password_confirmation') is-invalid @enderror" placeholder="Masukan confirm password">
                        </div>
                    </div>
                    ...
                    <div class="form-group d-flex mb-3 justify-content-between">
                        ...
                        <div style="width: 70%;">
                            <input type="number" name="no_telepon" id="no_telepon" class="form-control rounded-3 @error('no_telepon') is-invalid @enderror" placeholder="Masukan nomor telepon" value="{{ $mahasiswa->no_telepon }}" required>
                        </div>
                    </div>
                    @error('no_telepon')
                    <div class="text-danger mt-2">{{ $message }}</div>
                    ...
                    <div class="form-group mb-3 d-flex justify-content-between">
                        ...
                        <div style="width: 70%;">
                            <input type="text" name="nim" id="nim" class="form-control @error('nim') is-invalid @enderror" placeholder="Masukan nim" value="{{ $mahasiswa->nim }}" required>
                        </div>
                    </div>
                    @error('nim')
                    <div class="text-danger mt-2">{{ $message }}</div>
                    ...
                    <div class="form-group d-flex mb-3 justify-content-between">
                        ...
                        <div style="width: 70%;">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="matakuliah_ids[]" value="{{ $matakuliah->id }}" id="matakuliah{{ $matakuliah->id }}" {{ $mahasiswa->matakuliahs->contains($matakuliah->id) ? 'checked' : '' }}>
