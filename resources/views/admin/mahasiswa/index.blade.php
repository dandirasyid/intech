    ...
    <div class="container">
        <div class="bg-body my-4 p-3 border-0 rounded shadow">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h3 class="my-2 fw-bold" style="color: #10439F;">Data Mahasiswa</h3>
                </div>
                <div>
                    <a href="{{ route('admin_mahasiswa.create') }}" class="btn btn-sm text-white rounded fw-bold" style="background-color: #10439F;">Tambah Mahasiswa</a>
                </div>
            </div>
            <div class="d-flex align-items-center justify-content-between flex-wrap">
                ...
                <div>
                    <img src="{{ asset('images/data-mahasiswa.png') }}" alt="image-admin" class="img-fluid" style="max-width: 400px;">
                </div>
            </div>
        </div>
    </div>
    ...
    var KTDatatablesDataSourceAjaxServer = function() {
        var initTable1 = function() {
            ...
            table = table.DataTable({
                ...
                ajax: {
                    url: "{{route('admin_mahasiswa.datatable')}}",
                    type: "POST",
                },
                columns: [{
                        data: "DT_RowIndex",
