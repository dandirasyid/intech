    ...
    <div class="container">
        <div class="bg-body my-4 p-3 border-0 rounded shadow">
            <div class="d-flex justify-content-center align-items-center mb-1 col-md-12">
                <form action="{{ route('profile_update') }}" method="POST" enctype="multipart/form-data" class="col-md-8">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group mb-3 d-flex justify-content-between">
                        ...
                        <div style="width: 70%;">
                            <input type="text" name="name" id="name" class="form-control rounded-3 @error('name') is-invalid @enderror" placeholder="Masukan nama lengkap" value="{{ $user->name }}" required>
                        </div>
                    </div>
                    @error('name')
                    ...
                    <div class="form-group d-flex mb-3 justify-content-between">
                        ...
                        <div style="width: 70%;">
                            <input type="email" name="email" id="email" class="form-control rounded-3 @error('email') is-invalid @enderror" placeholder="Masukan email" value="{{ $user->email }}" required>
                        </div>
                    </div>
                    @error('email')
                    <div class="text-danger mt-2">{{ $message }}</div>
                    ...
                    <div class="form-group d-flex mb-3 justify-content-between">
                        ...
                        <div style="width: 70%;">
                            <input type="number" name="no_telepon" id="no_telepon" class="form-control rounded-3 @error('no_telepon') is-invalid @enderror" placeholder="Masukan nomor telepon" value="{{ $user->no_telepon }}" required>
                        </div>
                    </div>
                    @error('no_telepon')
                    <div class="text-danger mt-2">{{ $message }}</div>
                    ...
                    <div class="form-group mb-3 d-flex justify-content-between">
                        ...
                        <div style="width: 70%;">
                            <input type="text" name="nim" id="nim" class="form-control @error('nim') is-invalid @enderror" placeholder="Masukan nim" value="{{ $user->nim }}" required>
                        </div>
                    </div>
                    @error('nim')
                    <div class="text-danger mt-2">{{ $message }}</div>
                    ...
                    <div class="form-group d-flex mb-3 justify-content-between">
                        ...
                        <div style="width: 70%;">
                            <select class="form-select rounded-3" name="kelas_id" id="kelas_id">
                                ...
                                <option value="{{ $kelasItem->id }}" {{ $user->kelas_id == $kelasItem->id ? 'selected' : '' }}>{{ $kelasItem->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group d-flex mb-3 justify-content-between">
                        ...
                        <div style="width: 70%;">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="matakuliah_ids[]" value="{{ $matakuliah->id }}" id="matakuliah{{ $matakuliah->id }}" {{ $user->matakuliahs->contains($matakuliah->id) ? 'checked' : '' }}>
