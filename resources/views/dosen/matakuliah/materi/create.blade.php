    ...
    <div class="container">
        <div class="bg-body my-4 p-3 border-0 rounded shadow">
            <div class="d-flex justify-content-center align-items-center mb-1 col-md-12">
                ...
                @endif
                <form action="{{ route('store_materi', ['matakuliah_id' => $matakuliah->id]) }}" method="POST" enctype="multipart/form-data" class="col-md-8 my-5">
                    @csrf
                    <div class="form-group mb-3">
                        <h5 class="text-center fw-bold ">Tambah Materi {{$matakuliah->name}} </h5>
                    </div>
                    ...
                    <div class="form-group mb-3 d-flex justify-content-between">
                        ...
                        <div style="width: 70%;">
                            <input type="url" name="link_video" id="link_video" class="form-control rounded-3 @error('link_video') is-invalid @enderror" placeholder="Masukan link video materi" required>
                        </div>
                    </div>
                    @error('link_video')
                    <div class="text-danger mt-2">{{ $message }}</div>
